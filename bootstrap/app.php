...
require SHARED_PATH . DS . 'vendor/autoload' . EXT;
...
// $namespace = new Charti\Support\PhpFactory\PhpNamespace('App\Controllers');

// $class = $namespace->addClass('IndexProductsController');

// $class
//     ->setExtends(Dashboard\Controllers\Controller::class)
//     ->addTrait(Dashboard\ControllerConcerns\KnownFlashMessages::class)
//     ->addMethod('index')
//     ->addComment("This is an autogenerated Controller made by PageBuilder via Dashboard.\nDo not edit this class directly, instead, go to Dashboard and do it from UI.\n")
//     ->addComment('@see https://charti.dev/go/code-generation $form')
//     ->setBody('
// $perpage = 20;
// $total   = $post->count();
// $url     = Uri::href("dashboard/posts");
// ');
